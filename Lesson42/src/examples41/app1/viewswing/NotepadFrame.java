package examples41.app1.viewswing;
...
import examples41.app1.model.NoteEnum;
import examples41.app1.model.Notepad;

public class NotepadFrame extends JFrame {
//------------------------------------
    private File notepadFile;
    private Notepad n;
    private JButton buttonSaveZametka = new JButton("��������� �������");
    private JButton buttonShowZametka = new JButton("�������� �������");
    private JButton buttonSaveZadacha = new JButton("��������� ������");
    private JButton buttonShowZadacha = new JButton("�������� ������");
