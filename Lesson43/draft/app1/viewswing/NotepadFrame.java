package by.shipalex.day9.app1.viewswing;
...
//------------------------------------
    ...
    private Notepad n;
    private JButton buttonSaveZametka = new JButton("Сохранить заметку");
    private JButton buttonShowZametka = new JButton("Показать заметку");
    private JButton buttonSaveZadacha = new JButton("Сохранить задачу");
    private JButton buttonShowZadacha = new JButton("Показать задачу");
...
//-----------------------------------    
    ...
    private void jbInit() throws Exception {
        ...
        buttonSaveZametka.addActionListener(new ActionListener() {
    ...
    private void buttonOpen_actionPerformed(ActionEvent e) {
        ...
        statusBar.setText("Файл для работы выбран");
    }
    ...
    private void buttonSaveZadacha_actionPerformed(ActionEvent e) {
        try {
            ...
            statusBar.setText("Не сохранилось почему-то");
        }
    }
    ...
    private void buttonShowZametka_actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            statusBar.setText("Ошибка извлечения данных");
        }
